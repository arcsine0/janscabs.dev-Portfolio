      ...
      <Card className="bg-zinc-50 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700">
        ...
        <CardContent>
          <div className="bg-zinc-100 dark:bg-zinc-700 p-4 rounded-lg">
            {/* Replace this with an actual GitHub contributions graph or API integration */}
            <p className="text-center text-zinc-600 dark:text-zinc-400">GitHub contributions graph placeholder</p>
          </div>
        </CardContent>
      </Card>
    </motion.div>
